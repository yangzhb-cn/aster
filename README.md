...
详细项目规则、架构和历史经验见 [AGENTS.md](./AGENTS.md) 与 [docs/ai-readme/README.md](./docs/ai-readme/README.md)。相关思考文章会同步到个人博客：[yangzhb-cn.github.io](https://yangzhb-cn.github.io/)。
...
- [个人博客](https://yangzhb-cn.github.io/)：包含 Aster / Agent Harness 相关思考文章。
