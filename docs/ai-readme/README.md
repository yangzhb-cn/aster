...
| Web 多 Agent 聊天室 | 未实现 | 已实现 | 未实现 | 只有 Web 有 Room 页面、房间 CRUD、Agent CRUD、`@name`/`@all` 触发。 |
| Room Agent 配置管理 | 未实现 | 已实现 | 未实现 | Agent 的 name、role、alias、工具白名单、system prompt 在 Web 中维护。 |
